...
class CentralWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.button_load = QtWidgets.QPushButton(self)
        self.button_load.setGeometry(QtCore.QRect(10, 40, 121, 30))
        self.button_load.setObjectName("pushButton2")
        self.button_load.setText('Load project')

        self.button_rewrite = QtWidgets.QPushButton(self)
        self.button_rewrite.setGeometry(QtCore.QRect(10, 120, 101, 30))
        self.button_rewrite.setObjectName("pushButton4")
    ...
    def load_project(self):
        ...
        self.dirlist = QtWidgets.QFileDialog.getExistingDirectory(None, "Выбрать папку", ".")
        ...
        if self.dirlist:
            ...
            self.info_line.setText(f'Elements & images loaded from {self.dirlist}')
        else:
    ...
    def rewrite(self):
        ...
        self.info_line.setText(f'File {self.dirlist}/Контрольные точки/Points rewrote', )
        self.info_line.setStyleSheet("color: rgb(0, 200, 0);")
